...
(
    ...
    CONSTRAINT [FK_CarFeature_ToCarType] FOREIGN KEY ([car_type_id]) REFERENCES [CarType](car_type_id), 
...
CREATE INDEX [IX_CarFeature_CarType] ON [dbo].[CarFeature] ([car_type_id])
